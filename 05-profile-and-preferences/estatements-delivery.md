...
_Summerville Mobile › Profile & Preferences › Statements & eNotices_
...
* Member consolidating paperwork: Side Menu → Statements & eNotices → switch all eligible accounts to Electronic.
* Member retrieving a specific month's statement for a tax return: Side Menu → Statements & eNotices → pick account → pick month → download PDF.
* Compliance-driven paper retention: keep Paper explicitly to preserve mailed statements alongside the in-app copy.
