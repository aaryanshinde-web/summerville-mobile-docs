...
> A per-member quiet window — no push or SMS alerts during the configured hours — that respects the member's sleep schedule without turning off alerts entirely.

**How to get here:** Side Menu (☰) → **Alert Settings** → **Do-Not-Disturb**

### Step-by-Step Workflow

#### Step 1: Set the Quiet Window

Pick the **Time zone**, **Start Time**, and **End Time**. The preview banner below the fields confirms the effective window in plain language (e.g., *"You will not receive alerts between 10:00 PM and 07:00 AM the next day"*). **Do-Not-Disturb** applies the window; **Remove** clears it entirely. **More info** expands a help inline that explains what categories are (and aren't) suppressed.

![Step 1: Set the Quiet Window](../.gitbook/assets/Screenshot_1776963895.png)
...
* Sleep-mode defaults: 10 PM to 7 AM (the preview banner example) works for most members with no further tuning.
